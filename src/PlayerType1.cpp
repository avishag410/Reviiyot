...
PlayerType3::PlayerType3(GameManager &gameManager, string name):Player::Player(gameManager,name){}
...
PlayerType4::PlayerType4(GameManager &gameManager, string name):Player::Player(gameManager,name){}
